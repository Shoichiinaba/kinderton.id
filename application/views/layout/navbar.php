        ...
        <div class="container pr-3">
            <div class="row small-gutters">
                <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                    <div id="logo">
                        <a href="<?php echo base_url('dashboard'); ?>"><img
                                src="<?php echo base_url('assets'); ?>/img/logo-kinderton.png" alt="" width="100"
                                height="35"></a>
                    </div>
                </div>
                <nav class="col-xl-6 col-lg-7 top-menu-nav--5px">
                    ...
                    <div class="main-menu">
                        <div id="header_menu">
                            <a href="#"><img src="<?php echo base_url('assets'); ?>/img/kinderton coklat-30.png" alt=""
                ...
                <div
                    class="col-xl-3 col-lg-2 d-lg-flex align-items-center justify-content-end text-right top-icon-nav-5px">
                    <?php if (!$this->session->userdata('is_login')) : ?>
                    <li class="float-right list-none">
                        <a href="" class="ml-3 a-header-icon" data-toggle="modal" data-target="#modal-login"><i
                                class="fa-solid fa-right-to-bracket menu-icon-header"></i>
                        </a>
                    </li>
                    <?php else : ?>
                    <?php if ($this->session->userdata("privilage") == 'admin') { ?>
                    <li class="float-right list-none">
                        <a href="<?php echo base_url('Olah_data'); ?>" class="ml-3 a-header-icon"><i
                                class="fa-solid fa-database menu-icon-header"></i>
                            <span id="" class="badge badge-success navbar-badge-db notif-pesanan"></span>
                        </a>
                        <a href="#" class="ml-3 a-header-icon a-header-icon-user" data-toggle="dropdown"><span
                                class="user-acaunt mr-1"><?= $this->session->userdata("nm_user") ?></span> <i
                                class="fa-regular fa-user menu-icon-header"></i>
                        </a>
                        <div id="dropdown-user"
                            class="menu-dropdown dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <?php
                     ...
                     ?>
                    <li class="float-right list-none">
                        <a href="#" class="a-header-icon a-header-icon-user" data-toggle="dropdown"><span
                                class="user-acaunt mr-2"><?= $this->session->userdata("nm_user") ?></span> <i
                                class="fa-regular fa-user menu-icon-header"></i>
                        </a>
                        <div id="dropdown-user"
                            class="menu-dropdown dropdown-menu dropdown-menu-lg dropdown-menu-right mr-sm-5">
                            <div class="dropdown-divider"></div>
                            <a href="<?php echo base_url('user'); ?>" class="dropdown-item">
                                <i class="fa-regular fa-user"></i> <?= $this->session->userdata("nm_user") ?>
                            </a>
                    ...
                    <li class="float-right list-none btn_add_to_cart">
                        <a href="#page" id="btn-addtocart-favorit" class="ml-3 a-header-icon"><i
                                class="fa-regular fa-heart menu-icon-header"></i>
                            <span id="notif-favorit" class="badge badge-warning navbar-badge-favorit"></span>
                        </a>

                        <a href="#page" id="btn-cart" class="ml-3 a-header-icon"><i
                                class="fa-solid fa-cart-shopping menu-icon-header"></i>
