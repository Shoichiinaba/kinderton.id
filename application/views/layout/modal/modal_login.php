                    ...
                    <div class="container-fluid h-custom">
                        <div class="row d-flex justify-content-center align-items-center">
                            <div class="col-md-9 col-lg-6 col-xl-5">
                                <img src="<?php echo base_url('assets'); ?>/img/parallax.jpg"
                                    class="img-fluid mt-2 mb-2 b-radius-5px" alt="Sample image">
                            </div>
                            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                                <form action="<?php echo site_url('login'); ?>" method="POST">
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="gmail">Email address</label>
                                        <input type="email" id="gmail" class="form-control form-control-lg" name="gmail"
                                            placeholder="Enter a valid email address" autocomplete="current-gmail" />
                                    </div>
                                    ...
                                    <div class="text-center text-lg-start mt-4 pt-2">
                                        <button class="btn btn-primary btn-lg" type="submit" class="login-button"
