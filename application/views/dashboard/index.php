<main>
                                        ...
                                        <h2 class="owl-slide-animated owl-slide-title">
                                            ...
                                            <div class="owl-slide-animated owl-slide-cta">
                                                <a class="btn_1"
                                                    ...
                                                    class="img_container" role="button">Shop Now
                                                </a>
                                            </div>
                                    </div>
                                </div>
            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="owl-slide mt-5 pt-3">
                    <a href="<?php echo base_url(); ?>produk/category/<?php echo $kategoris; ?>">
                        <img class="slider-image"
                            src="<?php echo base_url('upload/banner'); ?>/<?php echo $slides->foto; ?>"
                            alt="Slider Image">
                    </a>
                </div>
                <!--/owl-slide-->
    ...
    foreach ($etalase as $etalases) {
            ...
            <li class="col-lg-4 col-md-3 col-sm-12 p-0">
                <a href="<?php echo base_url(); ?>produk/gender/<?php echo $etalases->kategori; ?>"
                    class="img_container" style="height: 30rem;">

                    <img src=" <?php echo base_url('upload/banner'); ?>/<?php echo $etalases->foto; ?>"
                        data-src="<?php echo base_url('upload/banner'); ?>/<?php echo $etalases->foto; ?>" alt=""
                        class="lazy">
        ...
        <div class="mt-0 mb-0" id="carousel-home">
            <ul id="banners_grid">
                ...
                ?>
                    <li class="col-lg-4 col-md-3 col-sm-12 p-0">
                        <a href="<?php echo base_url(); ?>produk/gender/<?php echo $etalases->kategori; ?>"
                            class="img_container" style="height: 25rem;">

                            <img src=" <?php echo base_url('upload/banner'); ?>/<?php echo $etalases->foto; ?>"
                                data-src="<?php echo base_url('upload/banner'); ?>/<?php echo $etalases->foto; ?>"
                                alt="" class="lazy">
                            <div class="short_info opacity-mask" data-opacity-mask="rgba(0,0,0, 0.2)">
                                <h3><?php echo $etalases->kategori; ?></h3>
                                <div><span class="btn_1">Shop Now</span></div>
                ...
                <div class="row justify-content-center justify-content-md-start">
                    <div class="col-lg-12 wow text-center" data-wow-offset="150">
                        <h2><img class="img-fluid mb-4 mr-0 pr-1 col-lg-2" src="upload/quots/Petik.png" alt=""
                                style="max-height: 20px; width: auto;"><?php echo $row->judul_quots; ?><img
                                class="img-fluid mb-4 pl-1 ml-0 col-lg-2" src="upload/quots/Petikb.png" alt=""
