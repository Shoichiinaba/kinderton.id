    ...
    <div class="col-6 col-md-4 col-xl-3">
        <div class="grid_item bg-white mb-1">
            ...
            <figure class="mb-1">
                ...
                <?php
                } else if ($row->status_produk == 'NEW') { ?>
                <span class="ribbon new"><?php echo $row->status_produk; ?></span>
                <?php
                } else if ($row->status_produk == 'PROMO') { ?>
                ...
                <a
                    ...
                    <?php
                                    ...
                                    ?>
                    <img class="img-fluid lazy" src="<?php echo base_url('upload'); ?>/<?php echo $foto2->fotpro; ?>"
            ...
            <ul>
                ...
                <li><a href="#" class="tooltip-1" data-toggle="modal" data-target="#modal-login" data-placement="left"
                ...
                <li><a href="#" class="tooltip-1 btn-favorit-produk-konfemail" title="Add to favorites"><i
                            class="ti-heart"></i><span>Add to favorites</span></a></li>
                <li><a href="#" class="tooltip-1 btn-cart-produk-konfemail" data-toggle="tooltip" data-placement="left"
                        title="Add to cart"><i class="ti-shopping-cart"></i><span>Add to cart</span></a></li>
                <?php } ?>
                <?php endif ?>
            </ul>
