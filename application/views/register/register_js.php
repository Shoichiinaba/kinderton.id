...
$(document).ready(function() {
    ...
    $('#btn-simpan-register').click(function(e) {
        ...
        $('#btn-simpan-register').addClass('btn-disabled').removeClass('btn-info').attr('disabled',
            true);
        $('#nm-user,#gmail,#kontak,#password,#alamat,#kota_tujuan').addClass('input_disabled').attr(
            'disabled', true);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        window.location.assign(
                            "<?php echo base_url('konfrim_akun'); ?>");
                    },
                    error: function() {
                        alert("Data Gagal Diupload");
                    }
