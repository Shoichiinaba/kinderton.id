<div class="container margin_76_35 bg-dashboard">
    <div class="row small-gutters">
        ...
        <div class="col-12">
            <button type="button" class="btn btn-rounded mr-2 btn-bg-kinderton btn-filter-produk btn-Boy"
                data-btn="Boy">Boys</button>
            <button type="button" class="btn btn-rounded mr-2 btn-bg-kinderton btn-filter-produk btn-Girl"
                data-btn="Girl">Grils</button>
            <button type="button" class="btn btn-rounded mr-2 btn-bg-kinderton btn-filter-produk btn-Unisex"
                data-btn="Unisex">Unisex</button>
        ...
        <div class="col-12">
            <button type="button" class="btn btn-rounded mr-2 btn-bg-kinderton btn-filter-produk btn-Longue-Wear"
                data-btn="Longue-Wear">Longue Wear</button>
            <button type="button" class="btn btn-rounded mr-2 btn-bg-kinderton btn-filter-produk btn-Formal-Wear"
                data-btn="Formal-Wear">Formal Wear</button>
            <button type="button" class="btn btn-rounded mr-2 btn-bg-kinderton btn-filter-produk btn-Modest-Wear"
                data-btn="Modest-Wear">Modest Wear</button>
            <button type="button" class="btn btn-rounded mr-2 btn-bg-kinderton btn-filter-produk btn-all">All</button>
        </div>
        <!-- </div> -->
        <?php
        ...
        <div id="produk<?php echo $filter; ?>" class="col-6 col-md-4 col-xl-3 col-produk">
            <div class="grid_item bg-white mb-1">
                ...
                <figure class="mb-1">
                    ...
                    <a
                        ...
                        <?php
                                    ...
                                    ?>
                        <img class="img-fluid lazy" src="<?php echo base_url('upload'); ?>/<?php echo $foto->fotpro; ?>"
                            data-src="<?php echo base_url('upload'); ?>/<?php echo $foto->fotpro; ?>" alt=""
                            data-foto="<?php echo $foto->fotpro; ?>">
                        <?php
                                        endforeach;
                                    }
                                    ?>
                        ...
                        <img class="img-fluid lazy"
                            src="<?php echo base_url('upload'); ?>/<?php echo $foto2->fotpro; ?>"
                            data-src="<?php echo base_url('upload'); ?>/<?php echo $foto2->fotpro; ?>" alt="">
                        <?php
                                        }
                                    }
                                    ?>
                ...
                <div class="price_box">
                    ...
                    var x = setInterval(function() {
                        var countDownDate = new Date(
                            "<?php echo $row->tgl_akhir_promo; ?> <?php echo $row->jam_akhir_promo; ?>");
                        ...
                        document.getElementById("countdown<?php echo $id_jp; ?>").innerHTML = days + "D" +
                            hours +
                            ":" + minutes + ":" + seconds + "";
                        ...
                        if (distance < 0) {
                            ...
                            if ($('#countdown<?php echo $id_jp; ?>').text() == 'EXPIRED' || $(
                                    '#countdown<?php echo $id_jp; ?>').text() == 'NAND') {
                                // alert('ya')
                                ...
                                $.ajax({
                                    ...
                                    success: function(msg) {
                                        $('.data-dashboard').load(
                                            '<?php echo site_url('Dashboard/data_dashboard'); ?>'
                                        );
                                    },
                                    error: function() {
                ...
                <ul>
                    ...
                    <li><a href="#" class="tooltip-1" data-toggle="modal" data-target="#modal-login"
                            data-placement="left" title="Add to favorites"><i class="ti-heart"></i><span>Add to
                                favorites</span></a></li>
                    <li><a href="#" class="tooltip-1" data-toggle="modal" data-target="#modal-login"
                            data-placement="left" title="Add to cart"><i class="ti-shopping-cart"></i><span>Add to
                                cart</span></a></li>
                    <?php else : ?>
                    <?php if ($this->session->userdata('status_user') == '1') { ?>
                    <li><a href="#" class="tooltip-1 btn-favorit-produk" data-id-produk="<?php echo $row->id_jp; ?>"
                            data-foto-produk="<?php echo $foto->fotpro; ?>" title="Add to favorites"><i
                                class="ti-heart"></i><span>Add to favorites</span></a></li>
                    <li><a href="<?php echo base_url(); ?>detail_produk/data/<?php echo $row->id_jp; ?>/<?php echo $nm_produk; ?>"
                            class="tooltip-1" data-toggle="tooltip" data-placement="left" title="Add to cart"><i
                                class="ti-shopping-cart"></i><span>Add to cart</span></a></li>
                    <?php } else { ?>
                    <li><a href="#" class="tooltip-1 btn-favorit-produk-konfemail" title="Add to favorites"><i
                                class="ti-heart"></i><span>Add to favorites</span></a></li>
                    <li><a href="#" class="tooltip-1 btn-cart-produk-konfemail" data-toggle="tooltip"
                            data-placement="left" title="Add to cart"><i class="ti-shopping-cart"></i><span>Add to
                                cart</span></a></li>
                    <?php } ?>
                    <?php endif ?>
