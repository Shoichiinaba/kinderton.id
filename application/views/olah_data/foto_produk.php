                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            <select class="form-control select2 height-2rem p-2px" id="select-nm-produk" name=""
                                required="true">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <button type="button" id="btn-form-foto-produk"
                            class="btn btn-sm bg-info float-right col-12">Tambah Data foto Produk</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <tbody id="data-foto">
                    ...
                    <tr id="" class="tr-foto-produk tr-foto-<?php echo $data_fp->id_jp; ?>">
                        ...
                        <td role="cell" scope="col"><img
                                src="<?php echo base_url('upload'); ?>/<?php echo $data_fp->fotpro; ?>" id=""
                        ...
                        <td role="cell" scope="col">
                            <a href="#page">
                                <button type="button"
                                    class="btn btn-xs bg-gradient-info elevation-3 btn-edit-foto-produk" id=""
                                    data-id-fotpro="<?php echo $data_fp->id_fotpro; ?>"
                                    data-id-fotjp="<?php echo $data_fp->id_fotjp; ?>"
                                    data-fotpro="<?php echo $data_fp->fotpro; ?>"
                                    data-texture="<?php echo $data_fp->texture; ?>"
                                    data-status-foto="<?php echo $data_fp->status_foto; ?>">
                                    <i class="fa-solid fa-pen-to-square"></i> Edit
                                </button>
                            </a>
                            <button type="button" data-id=""
                                class="btn btn-xs bg-gradient-danger elevation-3 hapus-foto-produk"
                                data-id-fotpro="<?php echo $data_fp->id_fotpro; ?>"
                                data-fotlama="<?php echo $data_fp->fotpro; ?>">
