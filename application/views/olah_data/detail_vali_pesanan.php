    ...
    <div class="private box">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 pb-1">
                ...
                <span class=""><?php echo $data->nm_jp; ?> || <?php echo $data->kategori; ?> ||
                    <?php echo $data->gender; ?></span>
                <br>
                <span class=""><?php echo $data->texture; ?> || <?php echo $data->size; ?> ||
                    <?php echo $data->qty; ?>X</span>
                <br>
                <?php
        ...
        <div class="row mt-1">
            <div class="col">
                <span class="text-bold float-right">Total Pembayaran <span
                        class="text-danger">Rp.<?php echo $data->total_pembayaran; ?></span></span>
            </div>
        </div>
        <hr>
        <div class="row">
            <div class="col">
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-12">
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input chekbox" type="checkbox" name="" id="acc"
                                    data-action="Dikemas">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input chekbox" type="checkbox" name="" id="tolak"
                                    data-action="Di-Tolak">
                    ...
                    <div class="col-lg-10 col-md-10 col-12">
                        <div id="form-ket-tolak" class="form-group">
                            <textarea type="text" id="ket-tolak" name="ket_ditolak" class="form-control" rows="3"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pl-0 pr-0">
                        <div id="" class="form-group">
                            <textarea type="text" id="" name="" class="form-control" rows="3"
                                readonly><?php echo $data->ket_ditolak; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn btn-sm btn-danger float-right hapus-data-pesana"
                            data-tr="<?php echo $data->status_pembayaran; ?><?php echo $data->id_cart; ?>"
                            data-kode-pesanan="<?php echo $data->kode_pesanan; ?>"
                            data-foto-bukti="<?php echo $data->foto_bukti; ?>" value="">Hapus data pesanan</button>
                    </div>
                </div>
                <?php
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pl-0 pr-0">
                        ...
                        <div class="form-group">
                            <p id="jam-kirim"></p>
                            <input type="number" id="etd-kirim" name="etd_kirim" class="form-control"
                                placeholder="Estimasi lama pengiriman ...">
                        </div>
                        <label for="no-resi">No Resi</label>
                        <div class="form-group">
                            <input type="text" id="no-resi" name="no_resi" class="form-control"
                                placeholder="No Resi ...">
                        </div>
                        <button type="button" id="btn-kirim-pesanan" class="btn col-12 btn-sm btn-success float-right"
        ...
        <div class="row">
            <div class="col">
                <button type="button" id="btn-acc" class="col-6 btn btn-sm btn-primary float-right"
                    data-kode-cart="<?php echo $data->kode_cart; ?>" value="">Dikemas</button>
                <button type="button" id="btn-tolak" class="col-6 btn btn-sm btn-danger float-right"
                    data-kode-cart="<?php echo $data->kode_cart; ?>" value="">Tolak</button>
            </div>
        </div>
    </div>
</div>
...
$('#btn-acc, #btn-tolak, #btn-kirim-pesanan').click(function(e) {
    ...
    $.ajax({
        ...
        success: function(msg) {
            ...
            $('.notif-pesanan_dikirim').load(
                '<?php echo site_url('chekout/notif_pesanan_dikirim'); ?>');

            if ($('.action-vali-pesanan').val() == 'Dikirim') {
                var nohp = '<?php echo $data->kontak; ?>';
                var pesan =
                    'horree.. Pesanan kamu sudah di antar ke alamat anda.. silahkan cek no resi kamu di sini: <?php echo base_url(); ?>/?pesanan=dikirim';
